...
$comando = $pdo->prepare("SELECT * FROM produtos, carrinho WHERE produtos.idprod = carrinho.idcar" );
    ...
    <div class="principal">
        ...
        <?php
            ...
            <div class=\"ult\">
                 ...
                 <div class=\"preencher\">
                    <img onclick=\"Fechar($idprod);\" class=\"fechar\" src='img/x.png' width=\"25px\">
                 </div>
